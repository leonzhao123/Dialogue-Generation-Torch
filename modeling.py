...
with open("idf_corpus", encoding="utf-8") as file:
    data = file.readlines()
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, masked_lm_labels=None,
        ...
        if decode == True:
            ...
            if train_ks == None:
                ...
                masked_lm_loss = batch_loss_mask_and_normalize( masked_lm_loss.float(), masked_weights)
...
class BertForSeq2SeqDecoder(PreTrainedBertModel):
    ...
    def __init__(self, config, mask_word_id=0, num_labels=2, num_rel=0, search_beam_size=1, length_penalty=1.0, eos_id=0, sos_id=0, forbid_duplicate_ngrams=False, forbid_ignore_set=None, not_predict_set=None, ngram_size=1, min_len=1, mode="s2s", pos_shift=False):
